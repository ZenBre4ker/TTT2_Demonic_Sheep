...
if ConVarExists("ttt_vote") then
	...
	print("\n------------TOTEM HudDrawTargetID-----------\n")
elseif TTT2 then
	--hook.Add("HUDDrawTargetID", "demonicsheep_TargetID", hudtargetidimpl_ttt2fixed)
	--hook.Add("TTTModifyTargetedEntity", "demonicsheep_TargetID", hudtargetidimpl_ttt2Simple)
	...
	print("\n------------Default HudDrawTargetID-----------\n")
end


local lastTimeCalled = CurTime()
hook.Add("HUDDrawTargetID", "demonicsheep_TargetIDTEST", thishookgotcalled)
function thishookgotcalled()
	local currentTime = CurTime()
	if currentTime - lastTimeCalled >= 5 then
		lastTimeCalled = currentTime
		print("This hook got called, yo. Current Time is " .. currentTime)
	end
end
